...
cdef extern from "LHAPDF/Version.h" namespace "LHAPDF":
    cdef string version()

cdef extern from "LHAPDF/Paths.h" namespace "LHAPDF":
...
cdef extern from "LHAPDF/Info.h" namespace "LHAPDF":
    cdef cppclass Info:
        bool has_key(string)
...
cdef extern from "LHAPDF/Config.h" namespace "LHAPDF":
    cdef cppclass Config(Info.Info):
        pass
    cdef int verbosity()
    cdef void setVerbosity(int)

cdef extern from "LHAPDF/PDFSet.h" namespace "LHAPDF":
...
cdef extern from "LHAPDF/AlphaS.h" namespace "LHAPDF":
...
cdef extern from "LHAPDF/PDFInfo.h" namespace "LHAPDF":
    cdef cppclass PDFInfo(Info.Info):
        pass #bool has_key(string)

cdef extern from "LHAPDF/Factories.h" namespace "LHAPDF":
...
cdef extern from "LHAPDF/Reweighting.h" namespace "LHAPDF":
